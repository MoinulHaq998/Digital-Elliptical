        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">Style Mart</h1>
                    <p className="md:text-xl  mb-4">Your All-in-One E-Commerce Platform</p>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
                        <button className="bg-primary text-white px-10 py-3 rounded-xl shadow hover:bg-opacity-90">
                            Get a demo
                        </button>
                        <button className="border border-blue-600 text-blue-600 px-10 py-3 rounded-xl shadow hover:bg-blue-100">
                            Free guidebook
                        </button>
                    </div>
                </div>        
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>Style Mart</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        Style Mart is an innovative e-commerce application designed to simplify shopping and deliver an exceptional online experience. Offering a wide range of products, the app caters to diverse customer needs across multiple categories. Whether you are looking for daily groceries, quality skincare products, or fresh fruits, Style Mart has it all.
                        </p>
            ...
            <div className="container md:mt-12 mt-20">
                ...
                {/* Text Section */}
                    <div className="md:px-12 px-4 md:mb-0 mb-8 md:w-[70%]">
                        ...
                        <ul className="tracking-wider text-gray-700 font-serif text-base leading-6  space-y-2">
                        <li><span className="font-semibold">Style Mart stands out for its versatility and commitment to quality. It provides:</span></li>
                        <li><span className="font-semibold">Extensive Product Categories:</span> 
                            <ul className='list-disc pl-6'>
                            <li>Food: A complete grocery selection, including fresh produce and packaged items.</li>
                            <li>Cosmetics: Premium beauty and makeup products for every occasion.</li>
                            <li>Pharmacy: Trusted healthcare essentials for everyday needs.</li>
                            <li>Skincare: High-quality skincare solutions tailored for all skin types.</li>
                            <li>Fruits: Fresh, seasonal, and organic fruits delivered to your doorstep.</li>
                            <li>And More: Expanding categories to meet evolving customer demands.</li>
                            </ul>
                        </li>

                        <li><span className="font-semibold">User-Centric Design: </span>
                            <ul className='list-disc pl-6'>
                            <li>Easy navigation with a visually appealing and responsive interface.</li>
                            <li>Efficient search and filter options for a seamless shopping experience.</li>
                            </ul>
                        </li>

                        <li><span className="font-semibold">Convenient Payment Options: </span> 
                            <ul className='list-disc pl-6'>
                            <li>Multiple payment modes, including mobile wallets, card payments, and cash on delivery.</li>
                            </ul>
                        </li>

                        <li><span className="font-semibold">Real-Time Order Tracking: </span> 
                            <ul className='list-disc pl-6'>
                            <li>Stay informed about your order status, from placement to delivery.</li>
                            </ul>
                        </li>
                        </ul>
                    </div>
                    ...
                    <div className='mt-10'>
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                ...
                                Style Mart is powered by cutting-edge technology to ensure reliable and secure operations. The application is developed using Flutter for its frontend, ensuring a consistent and smooth experience across both Android and iOS platforms. A robust backend infrastructure supports the app’s functionality, enabling quick and efficient processing of user requests and data.
                                </p>
                                </div>
                            </div>
                        </div>
