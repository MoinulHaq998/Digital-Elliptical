...
import img1 from "@/assets/services/ionic-bg.svg";
...
import {
  ...
  faqs,
  tabsApps,
} from "@/contant/servicesData/mobileAppDevelopment/ionic-app-development-services/page";
          ...
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6">
              ...
              <p className="lg:text-[21px] md:text-[18px] text-[16px] leading-[19px] md:leading-6 md:text-gray-600 md:font-normal font-medium text-black mb-2">
                Give Your App The Edge It Deserves With Ionic App Development
              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
                The word &quot;powerful performance&quot; sums up nicely how an app
                created with the Ionic framework functions. Being a leading
                provider of Ionic application development, all we could say is
                that, when compared to your competitors on the market, Ionic app
                development makes all the difference to your apps
                functionalities. With us, you can see the difference for
                yourself.
              </p>
