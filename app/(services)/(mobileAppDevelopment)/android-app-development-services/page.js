...
import img1 from "@/assets/services/android.svg";
import Process from "@/components/service/process/page";
import { tabsData ,choiceCardData,industriesCardData,faqs,tabsApps} from "@/contant/servicesData/mobileAppDevelopment/android-app-development-services/page";
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6">
              ...
              Launch your app on the most popular mobile platform in the world.

              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
              Digital Elliptical, a leading Android app development firm, offers end-to-end Android app development services to forward-thinking startups, eCommerce businesses, and major organizationss. Our expert Android app developers in the United States and the Middle East create straightforward mobile apps that please consumers and boost your business growth possibilities.
