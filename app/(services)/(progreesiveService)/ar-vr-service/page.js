...
import img1 from "@/assets/services/arvr-bg.svg";
...
import {
  ...
  faqs,
  tabsApps
} from "@/contant/servicesData/progreesiveService/ar-vr-service/page";
          ...
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6">
              ...
              <p className="lg:text-[21px] md:text-[18px] text-[16px] leading-[19px] md:leading-6 md:text-gray-600 md:font-normal font-medium text-black mb-2">
                By releasing futuristic applications with our AR/VR app
                development services, you can dominate your market.
              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
                Use services for AR/VR app development to your benefit and take
                full use of two of the mostunderutilizedtechnology. Through your
                apps, you can alter your user reality or transport them to an
                entirely different one. With the most innovative technologies
                available today, surprise them and leave them speechless.
              </p>
