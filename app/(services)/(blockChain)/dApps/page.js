...
import img1 from "@/assets/services/dApps.webp";
...
import {
  ...
  faqs,
  tabsApps
} from "@/contant/servicesData/blockChain/dApps/page";
      ...
      <section className="section-one">
        <div className="container">
          ...
          <div className='col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6'>
              <h1 className='lg:text-3xl text-[#212529] md:text-2xl text-[19px] text-nowrap font-bold mb-2.5'>
              ...
              <p className='lg:text-[21px] md:text-[18px] text-[16px] leading-[19px] md:leading-6 md:text-gray-600 md:font-normal font-medium text-black mb-2'>
                Leverage The Potential of P2P Technology For Your Apps
              </p>
              <p className='md:text-sm text-[13px] md:text-black text-gray-800 leading-6'>
                Decentralized application services are all about safety,
                security and performance. With blockchain technology powering
                the functionality of your dApps, your app is not just devoid of
                a central authority or location but comes with a range of
                benefits such as transparency, reliability, speed, security and
                more. Get a first-of-its-kind dApps developed from the most
                trusted dApps development company like us.
              </p>
