...
import img1 from "@/assets/services/crypto.webp";
...
import {
  ...
  industriesCardData,
  faqs,tabsApps
} from "@/contant/servicesData/blockChain/crypto-currency/page";
        ...
        <div className="container">
          ...
          <div className='col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6'>
              ...
              <p className='lg:text-[21px] md:text-[18px] text-[16px] leading-[19px] md:leading-6 md:text-gray-600 md:font-normal font-medium text-black mb-2'>
                Cryptocurrency Trading Made Simple with Our One-of-a-kind
                Cryptocurrency Application Development Services
              </p>
              <p className='md:text-sm text-[13px] md:text-black text-gray-800 leading-6'>
                At a time when the world is still coming to an understanding of
                what cryptocurrencies are, get an application designed and
                rolled out to stun your market segment. Our industry veterans
                will tell you how to go about developing your cryptocurrency app
                for your business. With the best Blockchain frameworks, we also
                arrive as a premier crypto-wallet development company.
              </p>
