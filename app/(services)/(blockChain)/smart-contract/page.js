...
import img1 from "@/assets/services/contract.webp";
...
import {
  ...
  faqs,
  tabsApps
} from "@/contant/servicesData/blockChain/smart-contract/page";
        ...
        <div className="container">
          ...
          <div className='col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6'>
              ...
              <p className='lg:text-[21px] md:text-[18px] text-[16px] leading-[19px] md:leading-6 md:text-gray-600 md:font-normal font-medium text-black mb-2'>
                Make Way For The Future of Digital Transactions With Our Smart
                Contract Blockchain Development Services
              </p>
              <p className='md:text-sm text-[13px] md:text-black text-gray-800 leading-6'>
                Powered by blockchain technology, smart contracts are the
                future. Insanely accurate, secure, transparent and efficient,
                smart contracts redefine the ways through which you execute
                transactions. Make use of the most reliable technological
                implementation for your banking, real estate, healthcare, retail
                or any other business venture today.
              </p>
