...
import img1 from '@/assets/services/4.svg'
import Process from "@/components/service/process/page";
import { tabsData ,choiceCardData,industriesCardData,faqs,tabsApps} from "@/contant/servicesData/webDevelopment/progressive-web-application/page";
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-12 md:px:6">
              ...
              Delight your users with an intuitive and user-friendly mobile experience

              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
              Digital Elliptical offers inclusive progressive web app development solutions to tech startups, global businesses and large-scale enterprises. Our experienced team of progressive developers design and launch progressive web apps that offer near-native experience to your prospects and target audiences.
      ...
      <section className="section-two relative">
        ...
        <div className="pt-[100px]">
          <div className="container">
            ...
            Progressive Web App Development Solutions for All Major Industries

            </h4>
            <p className="mb-8 text-center md:text-lg sm:text-base text-sm">
            Our experts have designed, developed hundreds of progressive web apps, over the years. We leverage our massive progressive web app development experience in creating user-friendly progressive web apps for a wide range of industries.
            </p>
