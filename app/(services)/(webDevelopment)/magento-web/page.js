...
import img1 from '@/assets/services/3.svg'
import Process from "@/components/service/process/page";
import { tabsData ,choiceCardData,industriesCardData,faqs,tabsApps} from "@/contant/servicesData/webDevelopment/magento-web/page";
      ...
      <section className="section-one">
        <div className="container">
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-8 md:px:6">
              ...
              Give Your Ecommerce Website the Flexibility It Deserves with Magento Web Development.


              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
              If you’re new to eCommerce web development, you wouldn’t probably be aware of the amazing features of magento. From fast-loading pages and SEO-friendly features to customizable functionalities and advanced reporting capabilities, Magento 2 development is what you need to make your eCommerce website stand out from the clutter. And on top of that, you need our efficient Magento development services as well.
