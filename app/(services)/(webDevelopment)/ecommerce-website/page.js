...
import { tabsData ,choiceCardData,industriesCardData,faqs,tabsApps} from "@/contant/servicesData/webDevelopment/ecommerce-website/page";
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-4 !min-h-[550px] mt-10 md:mt-0">
            <div className="col-span-12 lg:col-span-6 lg:text-start text-center flex flex-col justify-center px-1 lg:px-8 md:px:6">
              ...
              Launch your own eCommerce website with the help of our experts


              </p>
              <p className="md:text-sm text-[13px] md:text-black text-gray-800 leading-6">
              As a professional CMS and eCommerce development company, digital Elliptical offers reliable, robust and scalable eCommerce development services. Our professional team of eCommerce and CMS development experts follow best development practices to offer end-to-end Magento development, Shopify development and WordPress development solutions.
      ...
      <section className="section-two relative">
        ...
        <div className="pt-[100px]">
          <div className="container">
            ...
            Responsive Web Development Solutions for All Major Industries
