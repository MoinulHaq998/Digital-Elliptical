...
import Left from '@/assets/multi-apps/evspot/left.webp'
import Right from '@/assets/multi-apps/evspot/right.webp'
import Banner from '@/assets/multi-apps/evspot/bannar.webp'
import One from '@/assets/multi-apps/evspot/one.webp'
import Down from '@/assets/multi-apps/evspot/down.webp'
                ...
                <div className="container">
                    <div className="grid lg:grid-cols-6 gap-4">
                        ...
                        <div className="grid place-content-center gap-6 text-center col-span-4">
                            <h1 className='font-extrabold text-[35px] md:text-[40px] lg:text-[45px] xl:text-[50px]'>EV-Spot App Development</h1>
                            <p className='text-[20px] lg:text-[22px]'>Electrify your journey with our EV Spot App Development Solutions. Discover charging stations, track availability, and optimize your electric vehicle charging experience with our user-friendly app.</p>
                            <div>
                    ...
                    <div className="lg:w-[65%] mx-auto">
                        <div className='mb-16'>
                            ...
                            <p className='text-[19px] text-justify'>
                                Owners of electric vehicles (EVs) may easily find and access charging stations with the help of our EV Spot App Development Solutions. Our software intends to streamline the charging process, improve convenience, and support a sustainable future as electric vehicle use increases.
                                <br /><br />
