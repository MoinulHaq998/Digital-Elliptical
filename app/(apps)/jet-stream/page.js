        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">JET STREAM </h1>
                    <p className="md:text-xl  mb-4">
                        One-stop solution for Discovering, Booking, and Managing Services
                    </p>
                    <div className='mb-4'>
                        <Swiper
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>JET STREAM</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        The JET STREAM app is a one-stop solution for discovering, booking, and managing services from various establishments like salons, gyms, spas, and clinics. Designed with a user-centric approach, the app bridges the gap between service providers and customers, ensuring a seamless experience for both parties. 
                        </p>
                        <p className='tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        Its modern interface and robust features make it a go-to platform for health, beauty, and wellness services.
                        </p>
                    </div>
    ...
    >
      BetLab
            ...
            <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3  pl-3">
                <li><span className="font-semibold">Service Discovery:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Comprehensive listings of salons, gyms, spas, and clinics in the user area.</li>
                        <li>Advanced filters based on location, price range, ratings, and type of service.</li>
                        <li>Detailed profiles for each service provider, including photos, customer reviews, and pricing.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Booking System:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Real-time appointment booking with instant confirmation.</li>
                        <li>Calendar integration to track and manage upcoming bookings.</li>
                        <li>Rescheduling and cancellation options with notifications for updates.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Service Categories:</span>
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li><span className="font-semibold">Salons:</span> Haircuts, styling, coloring, manicures, pedicures, and more.</li>
                        <li><span className="font-semibold">Gyms:</span> Memberships, personal training sessions, group classes, and day passes.</li>
                        <li><span className="font-semibold">Spas:</span> Massages, facials, body treatments, and relaxation packages.</li>
                        <li><span className="font-semibold">Clinics:</span> General consultations, specialized treatments, and health check-ups.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">User-Friendly Interface:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Intuitive navigation with a clean, modern design.</li>
                        <li>Personalized recommendations based on user preferences and past bookings.</li>
                        <li>Multi-language support for diverse user bases.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Secure Payment Options:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Integration with multiple payment gateways for hassle-free transactions.</li>
                        <li>Support for credit/debit cards, digital wallets, and UPI.</li>
                        <li>Detailed invoices and transaction history.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Loyalty and Rewards Program:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Earn points on every booking for discounts and exclusive offers.</li>
                        <li>Tiered membership benefits for frequent users.</li>
                        <li>Seasonal and promotional deals from service providers.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Provider Dashboard:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Dedicated dashboard for service providers to manage bookings, schedules, and customer interactions.</li>
                        <li>Analytics and insights to track performance and customer satisfaction.</li>
                        <li>Options to add or update services, pricing, and availability.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Notifications and Reminders:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>Real-time alerts for booking confirmations, reminders, and updates.</li>
                        <li>Promotions and personalized offers delivered directly to the user’s device.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Additional Features:</span>
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li>24/7 in-app customer support via chat and email.</li>
                        <li>Transparent ratings and reviews for quality assurance.</li>
                        <li>Favorites list for quick access to preferred service providers.</li>
                        <li>Offline mode to access saved details and booking history without internet.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Target Audience:</span> 
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li><span className="font-semibold">Individuals: </span> Looking for beauty, fitness, wellness, or health services</li>
                        <li><span className="font-semibold">Service Providers: </span> Salons, gyms, spas, and clinics aiming to expand their customer base.</li>
                        <li><span className="font-semibold">Frequent Travelers: </span> Easily discover services in new locations.</li>
                    </ul>
                </li>
                <li><span className="font-semibold">Technology Stack</span>
                    <ul className="list-disc pl-4 space-y-1 mt-2">
                        <li><span className="font-semibold">Frontend: </span> Flutter for a unified experience on Android and iOS platforms</li>
                        <li><span className="font-semibold">Backend: </span> Laravel for scalable and secure backend operations.</li>
                        <li><span className="font-semibold">Database: </span> MySQL for efficient data handling and management.</li>
                        <li><span className="font-semibold">APIs: </span> Integration with payment gateways, location services, and third-party tools for added functionality.</li>
                    </ul>
                </li>
            </ul>
                    </div>
                        ...
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-4 list-disc">
                                 JET STREAM combines convenience, choice, and quality in one powerful platform. By connecting users with the best salons, gyms, spas, and clinics, it ensures that every customer finds the right service at the right time. The app’s robust features and user-centric design make it a trusted partner for health, beauty, and wellness needs.
                                </p>
                                </div>
                            </div>
                        </div>
