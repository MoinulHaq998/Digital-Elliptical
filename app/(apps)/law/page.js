...
function FoodDelivery() {
        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">LAW APP </h1>
                    <p className="md:text-xl  mb-4">
                        Platform to access Legal Assistance, Manage Cases
                    </p>
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>LAW APP</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        The LAW APP is a comprehensive solution designed to facilitate legal services for individuals and organizations. It offers users an intuitive platform to access legal assistance, manage cases, and stay updated with legal developments. 
                        </p>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                         The app integrates modern technology to ensure accessibility, efficiency, and reliability in the legal domain.
                        </p>
                    </div>
    ...
    <li><span className="font-semibold">Legal Document Templates:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Predefined templates for contracts, agreements, affidavits, and more.</li>
            <li>Customizable fields to cater to specific user requirements.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Lawyer Directory:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Search and filter functionality to find lawyers based on expertise, location, and ratings.</li>
            <li>Direct communication options via chat, call, or video conferencing.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Case Management:</span>
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Digital storage for case files and documentation.</li>
            <li>Timeline and milestone tracking for ongoing cases.</li>
            <li>Notifications and reminders for hearings and deadlines.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Legal Consultation Services:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>On-demand legal advice from verified professionals.</li>
            <li>Flexible appointment scheduling.</li>
            <li>Transparent pricing for consultations.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Knowledge Hub:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Access to a library of legal articles, FAQs, and case studies.</li>
            <li>Latest updates on laws, regulations, and court judgments.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Payment Integration:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Secure payment gateways for lawyer fees and other transactions.</li>
            <li>Invoice generation for user records.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Multi-Language Support:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Options to use the app in various languages to cater to diverse users.</li>
        </ul>
    </li>
    <li><span className="font-semibold">User-Friendly Dashboard:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Centralized access to user activities, updates, and pending tasks.</li>
            <li>Analytics and reports for professional users like lawyers and firms.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Additional Features:</span>
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li><span className="font-semibold">Real-Time Notifications: </span> Updates on case progress, deadlines, and lawyer availability.</li>
            <li><span className="font-semibold">Secure Data Handling: </span> End-to-end encryption to protect sensitive user information.</li>
            <li><span className="font-semibold">Offline Access: </span> View downloaded case documents and templates without internet access.</li>
            <li><span className="font-semibold">Customizable Profiles: </span> For lawyers, law firms, and users to showcase their expertise and preferences.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Target Audience:</span> 
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li>Individuals seeking legal advice or representation.</li>
            <li>Businesses and startups requiring contracts and legal consultations.</li>
            <li>Lawyers and law firms looking for a platform to connect with clients.</li>
        </ul>
    </li>
    <li><span className="font-semibold">Technology Stack:</span>
        <ul className="list-disc pl-4 space-y-1 mt-2">
            <li><span className="font-semibold">Frontend: </span>React Native for a seamless user experience across Android and iOS.</li>
            <li><span className="font-semibold">Backend: </span>Laravel for robust and scalable backend services.</li>
            <li><span className="font-semibold">Database: </span>MySQL for secure and efficient data management.</li>
            <li><span className="font-semibold">APIs: </span>Integration with payment gateways and third-party services for extended functionality.</li>
        </ul>
    </li>
                        </ul>
                    </div>
                        ...
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-4 list-disc">
                                    The LAW APP stands out for its simplicity, security, and comprehensiveness in addressing legal needs. 
                                    It bridges the gap between individuals and legal professionals, making the legal process accessible and manageable for everyone.
                                </p>
                                </div>
                            </div>
                        </div>
