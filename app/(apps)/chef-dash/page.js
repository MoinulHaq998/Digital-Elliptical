            ...
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                <div className="flex justify-center md:w-8/12 mb-4 md:mb-0">
                    <div className="relative">
                        <Image src={murammat1} alt='feature-img' width={2000} height={2000} className='w-full max-w-xs md:max-w-xl' />
                    </div>
                </div>
                <div className="md:w-1/2 mt-8 md:mt-0  md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">CHEF DASH</h1>
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>CHEF DASH</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        CHEF DASH is a revolutionary platform designed to connect professional chefs with food enthusiasts, offering a seamless way to explore personalized culinary experiences. 
                        </p>
                        <p className='tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        Whether you’re planning a private event, learning to cook, or seeking daily meal preparations, CHEF DASH ensures top-notch services tailored to your preferences.
                        </p>
                    </div>
                    <div className='flex items-center justify-center'>
                        <Image src={aidora1} alt='' height={2000} width={2000} className='w-[100%] h-auto rounded-xl' />
                    </div>
                </div>

            </div>

            <div className="container mx-auto md:mt-12 mt-20 px-4">
    <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-8">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
            <Image
                ...
                height={2000}
                width={2000}
                className="w-full h-auto max-w-md rounded-2xl shadow-md hover:scale-105 transform transition-all duration-300"
            />
        </div>
        {/* Key Features Section */}
        <div className="w-full md:w-1/2">
            <h6 className="text-3xl font-bold mb-6 text-primary text-center md:text-left">Key Features</h6>
            <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-4 pl-6 list-disc">
                <li>
                    <span className="font-semibold">Hire Professional Chefs:</span><br />
                    Book skilled chefs for private dinners, events, or regular meal preparations.
                </li>
                <li>
                    <span className="font-semibold">Customizable Menus:</span><br />
                    Collaborate with chefs to design menus that align with your taste and dietary needs.
                </li>
                <li>
                    <span className="font-semibold">Interactive Cooking Classes:</span><br />
                    Learn directly from experts through live or pre-recorded sessions.
                </li>
                <li>
                    <span className="font-semibold">Event Catering:</span><br />
                    Simplify event planning with professional catering services for any occasion.
                </li>
                <li>
                    <span className="font-semibold">Flexible Payment Options:</span><br />
                    Enjoy secure and convenient payment methods.
                </li>
            </ul>
        </div>
    </div>
            ...
            <div className='container md:mt-12 mt-12'>
                <div className='md:flex items-center justify-center '>
                    <div className=' md:mb-0 mb-8'> 
                        <p className="tracking-wider text-gray-700 text-[30px] text-center font-serif text-base leading-10 list-disc">
                        ...
                        CHEF DASH isn’t just for customers—it empowers chefs by offering a dedicated management dashboard to manage bookings, communicate with clients, and showcase their expertise.
                        </p>
                    </div>
                </div>
            </div>
      ...
      BetLab
                        ...
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                <div className='flex items-center justify-center w-full md:w-1/2'>
                                    <Image src={aidora1} alt='' height={2000} width={2000} className='w-[100%] h-auto px-2 rounded-xl' />
                                </div>
                                <div className='md:w-1/2 px-2'>
                                    <h4 className='text-3xl font-bold text-primary mb-3'>
                                    Why Choose CHEF DASH?</h4>
                                    <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-4 list-disc">
                                    <li>Tailored dining experiences with personalized services.</li>
                                    <li>Access to professional, verified chefs ensuring premium quality.</li>
                                    <li>Convenient real-time booking and scheduling.</li>
                                    <li>A wide range of cuisines and dietary-specific options.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            {/* Text Section */}
                ...
                <p className="text-base mt-6 text-gray-700 leading-relaxed">
                    <span className="font-semibold text-primary">CHEF DASH</span> is committed to revolutionizing the culinary world by bridging the gap between chefs and food lovers. 
                    We aim to celebrate the art of food, fostering convenience, creativity, and culture in every interaction.
                </p>
