...
import avGlobal4 from "@/assets/success-stories/av-global/1-04.webp";
import avGlobal5 from "@/assets/success-stories/av-global/1-02.webp";
            ...
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                <div className="flex justify-center md:w-8/12 mb-4 md:mb-0">
                    <div className="relative">
                        <Image src={avGlobal4} alt='feature-img' width={2000} height={2000} className='w-full max-w-xs md:max-w-xl' />
                    </div>
                </div>
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">Fitness App</h1>
                    <p className="md:text-xl  mb-4">Your Personalized Fitness Companion</p>
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>Fitness App</h6>
                    ...
                    <div className='flex items-center justify-center'>
                        <Image src={avGlobal5} alt='' height={2000} width={2000} className='w-[100%] h-auto' />
                    </div>
                    ...
                    <div className='mt-10'>
                        ...
                        <div className='space-y-4'>
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    Join groups, share progress, and connect with like-minded individuals for encouragement and accountability.
                                </p>
                            </div>
                            ...
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    A rich collection of video tutorials and instructional content for every fitness level and goal.
                                </p>
                            </div>
                            ...
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    Periodic assessments to evaluate progress and adjust fitness plans accordingly.
                                </p>
                            </div>
                        ...
                        <div className='space-y-4'>
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    Smart reminders to encourage workouts, hydration, and healthy eating habits.
                                </p>
                            </div>
                            ...
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    Sync data with devices like Fitbit, Garmin, and Apple Watch for seamless activity tracking.
                                </p>
                            </div>
                            ...
                            <div className='p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-500 ease-in-out group hover:scale-105'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-6">
                                    Download workouts and meal plans for use without an internet connection
                                </p>
                            </div>
                            </div>
                                </div>
