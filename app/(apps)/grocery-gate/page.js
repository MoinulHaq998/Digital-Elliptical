...
function FoodDelivery() {
    ...
    const techStackData = [
        {
          title: "Frontend",
          description: "Flutter for a smooth, cross-platform experience.",
          icon: "🚀", // Replace with actual icons if available
        },
        {
          title: "Backend",
          description: "Laravel to ensure a robust and scalable system.",
          icon: "⚙️",
        },
        {
          title: "Database",
          description: "MySQL for secure and efficient data storage.",
          icon: "📂",
        },
        {
          title: "APIs",
          description:
            "RESTful APIs for seamless communication between app modules.",
          icon: "🔗",
        },
      ];
        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">GROCERY GATE</h1>
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>GROCERY GATE</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                            GROCERY GATE is an innovative and user-friendly mobile application designed to simplify the grocery shopping experience. It offers a seamless platform where users can browse, order, and receive their groceries at their doorstep with just a few taps.
                        </p>
                        <p className='tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                            The app caters to a wide range of users, from busy professionals to homemakers, ensuring convenience and efficiency for everyone.
                        </p>
                    </div>
    ...
    >
      BetLab
            ...
            <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-4 pl-6 ">
                <li>
                    <span className="font-semibold">Intuitive User Interface:</span> 
                    <ul className="pl-6 list-disc">
                        <li>A clean and modern design for effortless navigation.</li>
                        <li>Categorized product listing for quick and easy browsing.</li>
                        <li>Search bar with advanced filters and auto-suggestions.</li>
                    </ul>
                </li>
                <li>
                    <span className="font-semibold">Product Categories:</span>
                    <ul className="pl-6 list-disc">
                        <li><span className="font-semibold">Fresh Produce:</span> Fruits, vegetables, and herbs.</li>
                        <li><span className="font-semibold">Dairy and Bakery:</span> Milk, cheese, eggs, and fresh bread.</li>
                        <li><span className="font-semibold">Packaged Foods:</span> Snacks, beverages, and ready-to-eat meals.</li>
                        <li><span className="font-semibold">Household Essentials:</span> Cleaning supplies, toiletries, and more.</li>
                    </ul>
                </li>
                <li>
                    <span className="font-semibold">Advanced Shopping Options:</span>
                    <ul className="pl-6 list-disc">
                        <li><span className="font-semibold">Smart Cart:</span> Auto-saves your cart for future use.</li>
                        <li><span className="font-semibold">Favorites:</span> Save frequently purchased items for quick access.</li>
                        <li><span className="font-semibold">Schedule Delivery:</span> Choose your preferred delivery date and time.</li>
                    </ul>
                </li>
                <li>
                    <span className="font-semibold">Secure Payment Methods:</span>
                    <ul className="pl-6 list-disc">
                        <li>Multiple payment options including credit/debit cards, mobile wallets, and cash on delivery.</li>
                        <li>PCI-DSS-compliant payment gateway for secure transactions.</li>
                    </ul>
                </li>
                <li>
                    <span className="font-semibold">Real-Time Order Tracking:</span>
                    <ul className="pl-6 list-disc">
                        <li> Track your order from placement to delivery.</li>
                        <li> Get instant notifications for every step of the process.</li>
                    </ul> 
                    
                </li>
                <li>
                    <span className="font-semibold">Exclusive Discounts and Offers:</span>
                    <ul className="pl-6 list-disc">
                        <li>Regular deals on popular items.</li>
                        <li>Special promotions for loyal customers.</li>
                    </ul>
                </li>
                <li>
          ...
          {techStackData.map((item, index) => (
                    ...
                    <div className='mt-10'>
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                ...
                                <li><span className="font-semibold">Convenience: </span>
                                    Shop anytime, anywhere, with a reliable delivery service.</li>
                                <li><span className="font-semibold">Variety: </span>
                                    Access a vast range of products under one platform.</li>
                                <li><span className="font-semibold">Affordability: </span>
                                    Competitive pricing with exciting discounts.</li>
                                <li><span className="font-semibold">Reliability: </span>
                                    Dependable customer service and timely deliveries.</li>
                                </ul>
                                </div>
                            </div>
                        </div>
            ...
            {/* Text Section */}
                ...
                <p className="text-base mt-6 text-gray-700 leading-relaxed">
                    <span className="font-semibold text-primary">GROCERY GATE </span> 
                    aims to revolutionize the grocery shopping experience by providing a hassle-free and efficient solution. Our mission is to save time, reduce effort, and enhance the quality of life for our users by delivering fresh and affordable groceries at their convenience.
                </p>
