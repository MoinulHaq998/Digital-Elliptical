        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                ...
                <div className="md:w-1/2 mt-8 md:mt-0 md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">Kitchen Connect </h1>
                    <p className="md:text-xl  mb-4">
                    Designed to Revolutionize Restaurant and Kitchen Management
                    </p>
                    <div className='mb-4'>
                        <Swiper
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>Kitchen Connect</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                            Kitchen Connect is a dynamic and versatile application designed to revolutionize restaurant and kitchen management. 
                            It offers a seamless blend of features tailored for restaurant owners, staff, and customers, ensuring an exceptional dining and operational experience. 
    ...
    >
      BetLab
            ...
            <div className="container md:mt-12 mt-20">
                ...
                {/* Text Section */}
                    <div className="md:px-12 px-4 md:mb-0 mb-8 md:w-[100%]">
            <h6 className="text-3xl font-bold mb-6 text-primary">Core Features of Kitchen Connect</h6>
            <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3  pl-3">
                <li><span className="font-semibold">Order Management:</span>
                <p className="mt-1">The app provides a comprehensive order management system. Restaurant owners can easily track and manage incoming orders, including online orders, dine-in orders, and takeaway requests. This feature ensures smooth operations and enhances customer satisfaction.
                </p></li>
                <li><span className="font-semibold">Dine-In Requests:</span> 
                <p className="mt-1">Kitchen Connect simplifies the dine-in experience by allowing customers to make table reservations directly through the app. Restaurants can accept, decline, or schedule requests based on availability, improving table turnover efficiency.
                </p></li>
                <li><span className="font-semibold">Add Restaurant:</span>
                <p className="mt-1">The app supports multi-restaurant functionality, enabling users to add and manage multiple restaurant profiles. Each profile includes essential details such as name, location, menu, and contact information, providing a centralized management solution.
                </p></li>
                <li><span className="font-semibold">Dine-In Service:</span> 
                <p className="mt-1">Restaurants can efficiently manage their dine-in services by monitoring table occupancy, taking orders directly from the table, and ensuring real-time communication between the kitchen and serving staff.
                </p></li>
                <li><span className="font-semibold">Product Management:</span> 
                <p className="mt-1">Managing the menu is effortless with the product management feature. Restaurants can add, edit, or remove items, categorize them, and set prices, images, and descriptions. This ensures an up-to-date menu for customers.
                </p></li>
                <li><span className="font-semibold">Special Offers and Discounts:</span> 
                <p className="mt-1">Attract more customers by creating and managing special offers, discounts, and combo deals. Restaurants can specify validity periods and conditions for each offer, promoting customer engagement and loyalty.
                </p></li>
                <li><span className="font-semibold">Working Hours Management:</span> 
                <p className="mt-1">Kitchen Connect allows restaurants to define their operational hours for different days of the week. This feature also supports holiday scheduling, ensuring accurate availability information for customers.
                </p></li>
                <li><span className="font-semibold">Reports and Analytics:</span> 
                <p className="mt-1">Restaurant owners can access detailed reports on sales, revenue, and customer preferences. This data helps in making informed business decisions and improving overall performance.
                </p></li>
                <li><span className="font-semibold">Staff Management:</span>
                <p className="mt-1">Manage your team effectively by assigning roles, tracking performance, and monitoring attendance. The app supports different user roles, including admin, manager, chef, and waiter.
                </p></li>
                <li><span className="font-semibold">Notifications and Alerts:</span> 
                <p className="mt-1">Stay updated with real-time notifications for new orders, reservations, and customer feedback. Alerts ensure you never miss important updates, enhancing responsiveness.
                </p></li>
                <li><span className="font-semibold">Multi-Language Support</span>
                <p className="mt-1">Kitchen Connect supports multiple languages, ensuring accessibility for a diverse audience, including customers and staff.
                </p></li>
                <li><span className="font-semibold">Customer Feedback and Reviews:</span> 
                <p className="mt-1">Gather valuable insights from customer feedback. Restaurants can respond to reviews and use suggestions to enhance their services.
                </p></li>
                <li><span className="font-semibold">Payment Integration:</span>
                <p className="mt-1">The app supports various payment methods, including cash, credit cards, and online payment gateways, providing customers with convenient options.
                </p></li>
                <li><span className="font-semibold">Delivery and Takeaway:</span> 
                <p className="mt-1">Seamlessly manage delivery and takeaway orders with integrated delivery partner tracking and estimated time of arrival features.
                </p></li>
                <li><span className="font-semibold">Kitchen Display System (KDS):</span>
                <p className="mt-1">Streamline kitchen operations with a Kitchen Display System that provides chefs with real-time order details, reducing errors and improving order preparation time.
                </p></li>
            </ul>
                    </div>
                {/* Image Section */}
                        ...
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                ...
                                <p className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-4 list-disc">
                                    Kitchen Connect is designed to simplify restaurant management while enhancing the overall dining experience. Its user-friendly interface, robust features, and adaptability to diverse business needs make it the perfect choice for restaurant owners looking to scale their operations.<br></br> 
                                    By incorporating this app into your portfolio, you demonstrate a commitment to innovation and excellence in the restaurant and kitchen management domain.
                                </p>
                                </div>
                            </div>
                        </div>
