...
import flexWheeler5 from "@/assets/success-stories/flex-wheeler/1-02.webp"
import flexWheeler6 from "@/assets/success-stories/flex-wheeler/1-04.webp"
            ...
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 md:p-10">
                <div className="flex justify-center md:w-8/12 mb-4 md:mb-0">
                    <div className="relative">
                        <Image src={flexWheeler6} alt='feature-img' width={2000} height={2000} className='w-full max-w-xs md:max-w-xl' />
                    </div>
                </div>
                <div className="md:w-1/2 mt-8 md:mt-0  md:text-left">
                    <h1 className="md:text-6xl text-4xl font-bold text-black md:mb-4">DINE-DIRECT</h1>
            ...
            <div className='container md:mt-12 mt-8'>
                <div className='md:flex items-center justify-center  '>
                    <div className='md:px-12 px-5 md:mb-0 mb-8'>
                        ...
                        <h6 className='text-4xl font-bold mb-2 text-primary '>DINE DIRECT</h6>
                        <p className=' tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        DINE-DIRECT is an innovative food delivery and restaurant aggregation platform designed to connect food enthusiasts with their favorite restaurants. 
                        </p>
                        <p className='tracking-wider text-[#454545] font-serif text-[15px] mb-3'>
                        Whether you are craving a gourmet meal, a quick snack, or a family dinner, DINE-DIRECT provides seamless access to an array of cuisines and dining options from multiple restaurants at your fingertips.
                        </p>
                    </div> 
                    <div className='flex items-center justify-center'>
                        <Image src={flexWheeler5} alt='' height={2000} width={2000} className='w-[100%] h-auto' />
                    </div>    
                </div>
            </div>
    ...
    >
      BetLab
            ...
            <div className='container md:mt-12 mt-20'>
                <div className='md:flex items-center justify-center '>
                    <div className='md:px-12 px-2 md:mb-0 mb-8 md:w-[70%]'> 
                        <h6 className="text-3xl font-bold mb-4 text-primary">Key Features</h6> 
                        <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-6 list-disc">
                            <li><span className="font-semibold">Wide Range of Restaurants: </span><br></br> Explore and order from an extensive list of restaurants offering diverse cuisines, including local eateries, fast-food chains, and fine dining establishments.</li>
                            <li><span className="font-semibold">User-Friendly Interface: </span><br></br> Navigate effortlessly through a well-designed, intuitive interface that ensures a hassle-free browsing and ordering experience.</li>
                            <li><span className="font-semibold">Real-Time Order Tracking: </span><br></br> Keep track of your order status with real-time updates from the restaurant kitchen to your doorstep.</li>
                            <li><span className="font-semibold">Personalized Recommendations: </span><br></br> Discover new dishes and restaurants based on your preferences and past orders with our smart recommendation system.</li>
                            <li><span className="font-semibold">Flexible Payment Options: </span><br></br> Pay your way with multiple payment options, including credit/debit cards, mobile wallets, and cash on delivery. </li>
                            <li><span className="font-semibold">Special Deals and Discounts: </span><br></br> Enjoy exclusive offers, discounts, and meal packages available only on DINE-DIRECT.</li>
                            <li><span className="font-semibold">Search and Filter Options: </span><br></br> Find exactly what you are looking for with advanced search and filter options by cuisine, price, ratings, and delivery time.</li>
                            <li><span className="font-semibold">Customer Reviews and Ratings: </span><br></br> Make informed decisions by viewing honest reviews and ratings from other customers.</li>
                            <li><span className="font-semibold">Pre-Order and Scheduled Deliveries: </span><br></br> Plan your meals in advance by scheduling orders for a specific date and time.</li>
                            <li><span className="font-semibold">Multi-Language Support: </span><br></br> Cater to a diverse audience by offering the app in multiple languages, ensuring accessibility for all users.</li>
                            <li><span className="font-semibold">Restaurant Management Panel: </span><br></br> A dedicated panel for restaurants to manage menus, orders, and customer feedback efficiently.</li>
                            <li><span className="font-semibold">Delivery Partner Integration: </span><br></br> Streamlined delivery management system with features for assigning, tracking, and monitoring deliveries.</li>
                        </ul>
                    </div>
                    <div className='flex items-center justify-center md:w-[30%]'>
                        <Image src={flexWheeler3} alt='' height={2000} width={2000} 
                        className='w-[100%] h-auto rounded-2xl shadow-md hover:scale-105 transform transition-all duration-300' />
                    </div>
                </div>
            </div>
                        ...
                        <div className='container md:mt-12 mt-10'>
                            <div className='md:flex items-center justify-center gap-8'>
                                <div className='flex items-center justify-center w-full md:w-1/2'>
                                    <Image src={flexWheeler5} alt='' height={2000} width={2000} className='w-[100%] h-auto px-2' />
                                </div>
                                <div className='md:w-1/2 px-2'>
                                    <ul className="tracking-wider text-gray-700 font-serif text-base leading-7 space-y-3 pl-4 list-disc">
                                    <li><span className="font-semibold">Convenience: </span> Order anytime, anywhere with just a few clicks.</li>
                                    <li><span className="font-semibold">Diversity: </span> Choose from a plethora of cuisines and restaurants.</li>
                                    <li><span className="font-semibold">Reliability:</span> Dependable delivery services with real-time tracking.</li>
                                    <li><span className="font-semibold">Quality Assurance:</span>Partnered with trusted and highly-rated restaurants.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div className="md:mt-24 mt-12"> 
                <div className="container md:p-12">
                    <div className="bg-gradient-to-r from-[#d7e8ff] to-[#c2dcff] rounded-2xl px-8 py-10 sm:flex items-center gap-8 shadow-lg">
            {/* Text Section */}
                        <div className="sm:w-7/12 md:px-10 text-center sm:text-left flex flex-col justify-center">
                <h5 className="md:text-4xl text-3xl text-primary font-bold leading-snug">
                    Vision and Mission
                </h5>
                <p className="text-base mt-6 text-gray-700 leading-relaxed">
                    <span className="font-semibold text-primary">DINE-DIRECT </span> 
                    aims to simplify and elevate the food ordering experience by bridging the gap between food lovers and their favorite dining spots. Our mission is to provide convenience, variety, and reliability to every customer, ensuring that quality meals are just a tap away.
                </p>
                <button className="mt-6 px-6 py-3 bg-primary text-white font-semibold text-sm rounded-lg shadow-md hover:bg-primary/80 transition-all">
                    Learn More
                </button>
                        </div>
            {/* Image Section */}
                        <div className="md:py-2 flex items-center pt-4 justify-center sm:w-5/12">
                <Image 
                    src={tabImg1} 
                    alt="Chef Dash Vision" 
                    width={2000} 
                    height={2000} 
