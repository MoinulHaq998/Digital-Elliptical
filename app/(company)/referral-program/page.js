...
import BannerReferal from "@/assets/company/referral.webp";
import Image from "next/image";
import { Icon } from "@iconify/react";
import ThemeButton from "@/components/ui/ThemeButton";
import Referral from "@/assets/company/referral-box.webp";
...
export default function Page() {
  ...
  const promise = [
    { img: promise1, title: "Technology process and talent set that has been proven" },
    { img: promise2, title: "Having a valid NDA, SLA, and MSA in place builds trust" },
    {
      img: promise3,
      title:
        "Strong team, resources, marketing materials, and communication channels, etc",
    },
    { img: promise4, title: "Global Clientele" },
    { img: promise5, title: "Under one roof, multiple service partnerships" },
  ];
  const cardData = [
    {
      no: "01",
      title: "Sign Up",
      description:
      "Join the program to join DigitalElliptical as a recognised partner.",
    },
    {
      no: "02",
      title: "Refer",
      description:
        "Refer customers looking for the best solutions in web development, IoT, blockchain, and other high-tech fields.",
    },
    {
      no: "03",
      title: "Match",
      description:
        "If the leads' needs and our services are a good fit, the leads are passed as qualified.",
    },
    {
      no: "04",
      title: "Convert",
      description:
        "When they match, your leads are successfully converted into our clients after agreeing on pricing, plans, procedures, and other factors.",
    },
    {
      no: "05",
      title: "Get Rewarded",
      description:
        "Receive rewards for each conversion that is successful.",
    },
    {
      no: "06",
      title: "Post Support",
  ...
  const benifits = [
    {
      titile:
        "Deliver a technical solution to your pal",
    },
    { titile: "Hassel-Free Additional income without spending any money" },
    {
      titile: "No business knowledge is necessary to create",
    },
    {
      titile:
    ...
    {
      titile:
        "It will be beneficial in and of itself to recommend a business with a track record of success, open communication, and reliable participation.",
    },
    {
      titile:
        "Have access to a referral program in addition to services and presales support",
    },
    {
      titile:
      ...
      <div className="lg:mt-16 mt-4">
        <div className="flex flex-col items-center justify-center gap-4 mt-4">
          ...
          <p className="text-[212529] text-[16px] -mt-10 lg:mt-0 leading-[24px] lg:w-[74%] w-[100%] p-4 text-center">
            With the brand-new referral program from DigitalElliptical
            Enterprise Solutions, you can earn money for every successful lead
            you send their way through a straightforward 5-step process.
          </p>
        </div>
        ...
        <div className="w-[100%] h-fit mb-10">
          <div className="lg:w-[80%] w-[95%] h-full mx-auto shadow-md bg-white flex lg:flex-row md:flex-row flex-col">
            <div className="lg:w-[55%] md:w-[55%]  w-[100%] mb-10 p-8">
              ...
              Become a Referral Partner. Make A Difference.
              </h1>
              <div className="mb-8">
        ...
        <div className="w-[100%] h-fit mt-10  p-8 bg-[#FAFAFA]">
          <div className="">
            ...
            Why Digital Elliptical Enterprise Solutions?
