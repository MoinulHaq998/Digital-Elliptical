...
import BannerStartup from "@/assets/company/startup.webp";
import Image from "next/image";
import { Icon } from "@iconify/react";
import ThemeButton from "@/components/ui/ThemeButton";
import Mentor from "@/assets/company/mentor.webp";
import MentorIcon1 from "@/assets/company/mentor-icon/1.svg";
import MentorIcon2 from "@/assets/company/mentor-icon/2.svg";
import MentorIcon3 from "@/assets/company/mentor-icon/3.svg";
import MentorIcon4 from "@/assets/company/mentor-icon/4.svg";
import MentorIcon5 from "@/assets/company/mentor-icon/5.svg";
...
export default function Page() {
  ...
  const promise = [
    { img: MentorIcon1, title: "Super-extensive wisdom on starting up" },
    { img: MentorIcon2, title: "Documentation and compliances" },
    {
      img: MentorIcon3,
      title: "Setting up teams, tech stacks, hiring strategies and more",
    },
    {
      img: MentorIcon4,
      title:
    ...
    {
      img: MentorIcon5,
      title: "Creating fresh opportunities for business expansions and more.",
    },
  ];
  const cardData = [
    {
      no: "01",
      title: "Conceptualization and Consultation",
      description:
        "Basics of Operating a Business Design and Development of Products further market and competitor research",
    },
    {
      no: "02",
      title: "Research and Learning",
      description:
        "Construct the Partnership Make a contract, then sign it Create a cross-promotional campaign Plan ahead to meet client demands by setting targets.Important Considerations When Choosing a Business Model Staffing and Recruitment Techniques Procedures for Product Development",
    },
    {
      no: "03",
      title: "Wireframing and Design",
      description:
        "Kickstarter UI/UX Color Psychology Market-specific Product Design and more",
    },
    {
      no: "04",
      title: "Proof of Concept",
      description:
        "Analysis of Features and Functionalities Scope and Potential Assessment Data-driven decision making, assumption elimination, and other concepts",
    },
    {
      no: "05",
      title: "MVP Development",
      description:
        "Principles of MVP Development Sample Set Generation Implementing MVP Strategie.",
    },
    {
      no: "06",
      title: "Fully Developed & Launched",
      description:
        "Market Reaching Initiatives Targeting the Right Marketing Channels Customer Acquisition Optimization",
    },
  ];
  const benifits = [
    {
      titile: "leaders in the field of technology development",
    },
    {
      titile:
    ...
    {
      titile: "Over 370 customers served",
    },
    {
      titile: "625+ projects delivered",
    },
    {
      titile: "The best developers, project managers and strategists on board",
    },
    {
      titile:
    ...
    <div>
      ...
      <div className="lg:mt-16 mt-4">
        <div className="flex flex-col items-center justify-center gap-4 mt-4">
          <h1 className="w-[80%] text-[#212529] lg:p-0 p-6 lg:text-[34px]  text-[24px] lg:leading-[34px] leading-[30px] text-center font-semibold">
            What Is the Tech Accelerator program at Digital Elliptical
            Enterprise Solutions?{" "}
          </h1>
          <p className="text-[212529] text-[16px] -mt-10 lg:-mt-2 leading-[24px] lg:w-[74%] w-[100%] p-4 text-center">
            To encourage the nation entrepreneurial spirit, Digital Elliptical
            Enterprise Solutions created and implemented this one-of-a-kind
            supercharged program. We are willing to teach, advise, support, and
            share all that we know about managing a successful firm in the
            modern era with up to 25 entrepreneurs. Every chosen entrepreneurial
            candidate is guided through the following crucial courses by our
            program.
          </p>
        </div>
          ...
          <div className="lg:w-[80%] w-[95%] h-full mx-auto shadow-md bg-white flex lg:flex-row md:flex-row flex-col">
            <div className="lg:w-[55%] md:w-[55%]  w-[100%] mb-10 p-8">
              <h1 className="text-[#212529] text-[28.8px] leading-[34.56px] font-semibold">
                Why Should You Seek Mentorship From Digital Elliptical
                Enterprise Solutions?
              </h1>
              <div className="mb-8">
          ...
          <div className="w-[80%] border lg:gap-0 gap-4  lg:p-10 p-4 flex lg:flex-row flex-col justify-between items-start lg:items-center h-full mx-auto">
            <div>
              <p className="text-[#212529] lg:text-[20px] text-[16px] font-semibold">
                Come partner with the pioneers of tech solutions.
              </p>
                              ...
                              <div>
                                <div className="grid lg:grid-cols-2 md:grid-cols-2  grid-cols-1 lg:gap-6 gap-10 mt-10 md:mt-16 mb-10 md:mb-16">
                                  ...
                                  <div className="flex items-center justify-center flex-col text-center">
                                    <h4 className="flex items-center lg:text-3xl text-[#212529] text-xl md:text-2xl mb-1 font-bold">
                                      1275{" "}
                                      <Icon
                                        icon="ic:sharp-plus"
                                        width="24"
