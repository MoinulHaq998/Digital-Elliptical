...
import HTML from "@/assets/All-Icons/html.svg";
...
const Languages = [
  {
    head: "Languages",
    dis: "Our full stack web development solutions harness all leading web development languages and frameworks that are known to expand the scope and capabilities of a web project. Using reliable languages and powerful frameworks, we promise excellent results every time.",
    icons: [
...
const CMS = [
  {
    head: "CMS",
    dis: "CMS or content management system makes it easier to handle content requirements of your website or web project. We use cutting edge CMS frameworks that simplifies management at your end, empowering you to make the most out of your content publishing efforts.",
    icons: [
      { name: "Node Js", icon: NodeJS },
      { name: "Laravel", icon: Laravel },
      { name: "Php", icon: PHP },
...
const DataBase= [
  {
    head: "Data Base",
    dis: "Our expert iPhone app developers recognise the necessity of a solid database management system for a mobile app's success. To guarantee that there are no risks of data failure, we Utilize strong app database management solutions.",
    icons: [
...
export const tabsApps = [
  { name: "La", spanText: "nguages", tab: "Languages" },
  { name: "CM", spanText: "S", tab: "CMS" },
